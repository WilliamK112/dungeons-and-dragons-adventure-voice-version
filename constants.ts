...
/** Pre-filled for competition judges. Key stays server-side when using backend; masked in UI to avoid DOM exposure. */
export const DEMO_API_KEY = 'AIzaSyA_W4aSmLdizMYjZ81qyGRWlTNlyzXrDb4';
