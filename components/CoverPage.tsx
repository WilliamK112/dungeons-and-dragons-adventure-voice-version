...
interface CoverPageProps {
  ...
  maskKeyDisplay?: boolean;
}

const MASKED_PLACEHOLDER = '••••••••••••••••••••••••••••••••••••••••';

const CoverPage: React.FC<CoverPageProps> = ({ onStart, isLoading, error, onConnectKey, isApiKeySelected, apiKeyInput, apiKeyStatus, onSaveApiKey, maskKeyDisplay }) => {
  ...
  const displayValue = (maskKeyDisplay && draftKey === apiKeyInput) ? MASKED_PLACEHOLDER : draftKey;
        ...
        {!isLoading && (
            <div className="flex flex-col items-center gap-6 w-full max-w-xl">
                ...
                >
                  ...
                  <div className="mt-3 rounded-lg border-2 border-emerald-300 bg-black/80 px-3 py-2 text-center text-sm font-bold text-emerald-200 shadow-lg">
                    temperatory API-key is pasted above for you: 
